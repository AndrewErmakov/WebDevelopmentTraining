...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('title', 'description', 'price', 'sale_start_time', 'rubric', 'avg_rating', 'count_reviews')
    list_display_links = ('title', 'description')
    search_fields = ('title', 'description', 'price', 'rubric', 'avg_rating', 'count_reviews')
